...
def compute_metrics_for_region_label(
    ...
    for r in regions_or_labels:
        ...
        if tp + fp + fn == 0:
            results[key_name][r]["Dice"] = np.nan
            results[key_name][r]["IoU"] = np.nan
        else:
            results[key_name][r]["Dice"] = 2 * tp / (2 * tp + fp + fn)
            results[key_name][r]["IoU"] = tp / (tp + fp + fn)
        ...
        results[key_name][r]["FP"] = fp
        results[key_name][r]["TP"] = tp
        results[key_name][r]["FN"] = fn
        results[key_name][r]["TN"] = tn
